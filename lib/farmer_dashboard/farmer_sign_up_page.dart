...
import 'package:spicer/login/farmer_login_page.dart'; // Destination after successful sign up
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                ElevatedButton(
                  ...
                  child: const Text('Sign Up & Start Listing', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
                ),
                const SizedBox(height: 20),
